  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <!-- End of Topbar -->
        <div style="color: black; font-size: 40px;"> <center>
          GENERATE LAPORAN
        </center> </div> <br> <br>
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="h5 mb-0 font-weight-bold text-gray-800"> <a href="data_pegawai.php">  Data Pegawai </a> </div>
                    </div>
                    <div class="col-auto">
              ...
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1"></div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"> <a href="data_masyarakat.php">  Data Masyarakat </a> </div>
                    </div>
                    <div class="col-auto">
              ...
              <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1"></div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"> <a href="data_laporan.php">  Data Pengaduan </a> </div>
                    </div>
                    <div class="col-auto">
