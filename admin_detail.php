...
<!-- Begin Page Content -->
        <div class="container-fluid">
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="post" role="form" enctype="multipart/form-data" action="admin_proses.php">
               <?php
                  include"koneksi.php";
        ...
        <div>
           ...
           <a href="admin_verifikasi.php" class="btn btn-danger btn-icon-split" onclick="return confirm('Yakin Akan di Proses?')">
            <span class="icon text-white-50">
