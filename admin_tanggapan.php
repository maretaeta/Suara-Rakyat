      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="card shadow">
            ...
            <div class="card-body">
              <form action="admin_simpantanggapan.php" method="post" role="form" enctype="multipart/form-data">
                <div class="form-group cols-sm-6">
                  <label>Tanggal Pengaduan </label>
                  <input type="text" name="tgl_tanggapan" class="form-control" value="<?php echo date('d/m/Y'); ?>" >
                </div>
                 <div class="form-group cols-sm-6">
