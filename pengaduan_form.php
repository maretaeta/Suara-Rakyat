...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #B22222">
      ...
      <li class="nav-item">
        <a class="nav-link" href="pengaduan_form.php">
      ...
      <li class="nav-item">
        <a class="nav-link" href="pengaduan_lihat.php">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <div class="card shadow">
            <div class="card-header"> Tulis Pengaduan </div>
            <div class="card-body">
              <form action="pengaduan_simpan.php" method="post" role="form" enctype="multipart/form-data">
                <div class="form-group cols-sm-6">
                  <label>Tanggal Pengaduan </label>
                  <input type="text" name="tgl_pengaduan" class="form-control" value="<?php echo date('d/m/Y'); ?>" >
                </div>
                 <div class="form-group cols-sm-6">
                  <label>NIK </label>
